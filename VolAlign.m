...
% todd messing with my code
pid = []; % vector of patient ids
    % in a loop with a patient index pInd
    
mri=ea_load_nii(['/Users/finks/Desktop/Projects/STN_Figure/STN_Fig_Imgs/' num2str(pid(pInd)) '/T1w_hires.nii']);
